...
class User(AbstractBaseUser):
    ...
    qatype = models.IntegerField(verbose_name='질문 타입', blank=True, null=True)
    qaAnswer = models.TextField(verbose_name="질문 답안", blank=True, null=True)
    token = models.TextField(verbose_name="firebase 토큰", blank=True, null=True)
